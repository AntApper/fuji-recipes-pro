...
A cross-platform native macOS & iOS application suite designed for **Fujifilm X100VI** photographers. **FujiRecipes Pro** connects directly over USB-C (PTP) to manage camera recipes, formulate custom dial banks (**C1–C7**), and trigger in-camera RAW (`.RAF`) conversion with hardware film simulation recipes.

---

## 📸 Highlights & Modern 2026 Interface
...
| **macOS 2026 Fluid Glass UI** | ✅ Complete | Satin darkroom aesthetic, responsive scaling |
